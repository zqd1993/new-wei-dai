...
import com.fdjerymglkfgh.erugjhaharefg.ruyidaivhernrfutil.RuYiDaiKidunDownloadApkUtil;
...
public class GoodsDetailsRuYiDaiKidunActivity extends BaseRuYiDaiKidunActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsRuYiDaiKidunActivity.this);
        ...
        RuYiDaiKidunDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new RuYiDaiKidunDownloadApkUtil.OnDownloadListener() {
            @Override
