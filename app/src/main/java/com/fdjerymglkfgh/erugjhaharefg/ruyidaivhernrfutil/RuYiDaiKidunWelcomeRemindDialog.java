...
public class RuYiDaiKidunWelcomeRemindDialog extends Dialog {

    ClickRuYiDaiKidunTextView content_tv;
    TextView topBtn;
    TextView bottomBtn;

    private OnListener onListener;

    public RuYiDaiKidunWelcomeRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_remind_ru_yi_dai_dfu_eng);
        ...
        content_tv.setText(StaticRuYiDaiKidunUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
