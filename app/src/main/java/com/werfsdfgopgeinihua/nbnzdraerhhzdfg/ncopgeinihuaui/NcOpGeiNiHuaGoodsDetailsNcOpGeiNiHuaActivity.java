...
import com.werfsdfgopgeinihua.nbnzdraerhhzdfg.ncopgeinihuautil.NcOpGeiNiHuaDownloadApkUtil;
...
public class NcOpGeiNiHuaGoodsDetailsNcOpGeiNiHuaActivity extends BaseNcOpGeiNiHuaActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(NcOpGeiNiHuaGoodsDetailsNcOpGeiNiHuaActivity.this);
        ...
        NcOpGeiNiHuaDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new NcOpGeiNiHuaDownloadApkUtil.OnDownloadListener() {
            @Override
