...
public class NcOpGeiNiHuaHWDeviceIDHelper {
    private Context mContext;
    public final LinkedBlockingQueue<IBinder> linkedBlockingQueue = new LinkedBlockingQueue(1);

    public NcOpGeiNiHuaHWDeviceIDHelper(Context ctx) {
        mContext = ctx;
    }

    public void getHWID(NcOpGeiNiHuaDevicesIDsHelper.AppIdsUpdater _listener) {
        try {
        ...
        if (isBin) {
            try {
                ...
                NcOpGeiNiHuaHWIDInterface.NcOpGeiNiHuaHWID hwID = new NcOpGeiNiHuaHWIDInterface.NcOpGeiNiHuaHWID(iBinder, mContext);
