...
public class NcOpGeiNiHuaDevicesIDsHelper {
    private AppIdsUpdater _listener;

    public NcOpGeiNiHuaDevicesIDsHelper(AppIdsUpdater callback) {
        _listener = callback;
    }
    ...
    public void getOAID(Context mcontext) {
        ...
        if ("ASUS".equals(manufacturer)) {
            ...
            oaid = new NcOpGeiNiHuaVivoDeviceIDHelper(mcontext).getOaid();

        } else if ("XIAOMI".equals(manufacturer)) {

            oaid = new NcOpGeiNiHuaXiaomiDeviceIDHelper(mcontext).getOAID();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                if ("OPPO".equals(manufacturerm)) {
                    new NcOpGeiNiHuaOppoDeviceIDHelper(context).getID(_listener);
                } else if ("HUAWEI".equals(manufacturerm)) {
                    new NcOpGeiNiHuaHWDeviceIDHelper(context).getHWID(_listener);
