...
public interface NcOpGeiNiHuaHWIDInterface extends IInterface {
    String getIDs();

    boolean getBoos();

    public final class NcOpGeiNiHuaHWID implements NcOpGeiNiHuaHWIDInterface {
        private IBinder iBinder;
        private Context context;

        public NcOpGeiNiHuaHWID(IBinder ib, Context ct) {
            iBinder = ib;
            context = ct;
        }
