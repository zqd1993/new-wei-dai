package com.werfsdfgopgeinihua.nbnzdraerhhzdfg.ncopgeinihuautil;
...
public class NcOpGeiNiHuaStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static NcOpGeiNiHuaStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static NcOpGeiNiHuaStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        NcOpGeiNiHuaStatusBarView ncOpGeiNiHuaStatusBarView = new NcOpGeiNiHuaStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        ncOpGeiNiHuaStatusBarView.setLayoutParams(params);
        ncOpGeiNiHuaStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        ncOpGeiNiHuaStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return ncOpGeiNiHuaStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static NcOpGeiNiHuaStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        NcOpGeiNiHuaStatusBarView ncOpGeiNiHuaStatusBarView = new NcOpGeiNiHuaStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        ncOpGeiNiHuaStatusBarView.setLayoutParams(params);
        ncOpGeiNiHuaStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        ncOpGeiNiHuaStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return ncOpGeiNiHuaStatusBarView;
    }
