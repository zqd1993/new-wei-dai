...
public class NcOpGeiNiHuaRemindDialog extends Dialog {
    ...
    public NcOpGeiNiHuaRemindDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
