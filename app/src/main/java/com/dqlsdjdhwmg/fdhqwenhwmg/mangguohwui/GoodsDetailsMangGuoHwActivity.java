...
import com.dqlsdjdhwmg.fdhqwenhwmg.mangguohwutil.MangGuoHwDownloadApkUtil;
...
public class GoodsDetailsMangGuoHwActivity extends BaseMangGuoHwActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsMangGuoHwActivity.this);
        ...
        MangGuoHwDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new MangGuoHwDownloadApkUtil.OnDownloadListener() {
            @Override
