...
public class MangGuoHwGoodsListAdapter extends BaseQuickAdapter<MangGuoHwGoodsModel, BaseViewHolder> {

    private ItemClickListener itemClickListener;

    public MangGuoHwGoodsListAdapter(int layoutResId, @Nullable List<MangGuoHwGoodsModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MangGuoHwGoodsModel item) {
        ...
        Glide.with(mContext).load(MangGuoHwRetrofitManager.API_BASE_URL + item.getProductLogo()).into(goodsPic);
    ...
    public interface ItemClickListener{
        void onItemClicked(MangGuoHwGoodsModel item);
    }
}
