...
public class RemindMangGuoHwDialog extends Dialog {
    ...
    public RemindMangGuoHwDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_mang_guo_hw_remind);
