...
public class StatusBarUtilMangGuoHw {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewMangGuoHw createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewMangGuoHw createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewMangGuoHw statusBarViewMangGuoHw = new StatusBarViewMangGuoHw(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewMangGuoHw.setLayoutParams(params);
        statusBarViewMangGuoHw.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewMangGuoHw.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewMangGuoHw;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewMangGuoHw createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewMangGuoHw statusBarViewMangGuoHw = new StatusBarViewMangGuoHw(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewMangGuoHw.setLayoutParams(params);
        statusBarViewMangGuoHw.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewMangGuoHw.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewMangGuoHw;
    }
