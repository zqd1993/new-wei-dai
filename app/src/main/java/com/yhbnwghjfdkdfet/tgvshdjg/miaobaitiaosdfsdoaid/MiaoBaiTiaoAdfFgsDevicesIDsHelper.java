...
public class MiaoBaiTiaoAdfFgsDevicesIDsHelper {
    private AppIdsUpdater _listener;

    public MiaoBaiTiaoAdfFgsDevicesIDsHelper(AppIdsUpdater callback) {
        _listener = callback;
    }
    ...
    public void getOAID(Context mcontext) {
        ...
        if ("ASUS".equals(manufacturer)) {
            ...
            oaid = new MiaoBaiTiaoAdfFgsVivoDeviceIDHelper(mcontext).getOaid();

        } else if ("XIAOMI".equals(manufacturer)) {

            oaid = new MiaoBaiTiaoAdfFgsXiaomiDeviceIDHelper(mcontext).getOAID();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                if ("OPPO".equals(manufacturerm)) {
                    new MiaoBaiTiaoAdfFgsOppoDeviceIDHelper(context).getID(_listener);
                } else if ("HUAWEI".equals(manufacturerm)) {
                    new MiaoBaiTiaoAdfFgsHWDeviceIDHelper(context).getHWID(_listener);
