...
public class MiaoBaiTiaoAdfFgsOppoDeviceIDHelper {
    private Context mContext;
    public String oaid = "OUID";
    private String sign;
    MiaoBaiTiaoAdfFgsOppoIDInterface miaoBaiTiaoAdfFgsOppoIDInterface;

    public MiaoBaiTiaoAdfFgsOppoDeviceIDHelper(Context ctx) {
        mContext = ctx;
    }


    public String getID(MiaoBaiTiaoAdfFgsDevicesIDsHelper.AppIdsUpdater _listener) {
        ...
        if (mContext.bindService(intent, serviceConnection, Context.BIND_AUTO_CREATE)) {
            ...
            if (miaoBaiTiaoAdfFgsOppoIDInterface != null) {
    ...
    private String realoGetIds(String str) {
        ...
        res = ((MiaoBaiTiaoAdfFgsOppoIDInterface.up.down) miaoBaiTiaoAdfFgsOppoIDInterface).getSerID(pkgName, sign, str);
        return res;
    }
    ...
    ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            miaoBaiTiaoAdfFgsOppoIDInterface = MiaoBaiTiaoAdfFgsOppoIDInterface.up.genInterface(service);
        }

        @Override
        public void onServiceDisconnected(ComponentName name) {
            miaoBaiTiaoAdfFgsOppoIDInterface = null;
        }
    };
