...
public class MiaoBaiTiaoAdfFgsStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewMiaoBaiTiaoAdfFgs createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewMiaoBaiTiaoAdfFgs createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewMiaoBaiTiaoAdfFgs statusBarViewMiaoBaiTiaoAdfFgs = new StatusBarViewMiaoBaiTiaoAdfFgs(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewMiaoBaiTiaoAdfFgs.setLayoutParams(params);
        statusBarViewMiaoBaiTiaoAdfFgs.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewMiaoBaiTiaoAdfFgs.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewMiaoBaiTiaoAdfFgs;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewMiaoBaiTiaoAdfFgs createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewMiaoBaiTiaoAdfFgs statusBarViewMiaoBaiTiaoAdfFgs = new StatusBarViewMiaoBaiTiaoAdfFgs(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewMiaoBaiTiaoAdfFgs.setLayoutParams(params);
        statusBarViewMiaoBaiTiaoAdfFgs.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewMiaoBaiTiaoAdfFgs.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewMiaoBaiTiaoAdfFgs;
    }
