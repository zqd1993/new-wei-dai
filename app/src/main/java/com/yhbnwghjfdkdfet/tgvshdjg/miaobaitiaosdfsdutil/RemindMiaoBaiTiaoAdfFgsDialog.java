...
public class RemindMiaoBaiTiaoAdfFgsDialog extends Dialog {
    ...
    public RemindMiaoBaiTiaoAdfFgsDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_miao_bai_tiao_sdf_remind);
