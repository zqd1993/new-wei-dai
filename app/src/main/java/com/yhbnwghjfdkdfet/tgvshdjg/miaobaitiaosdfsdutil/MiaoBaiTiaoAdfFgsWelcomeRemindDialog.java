...
public class MiaoBaiTiaoAdfFgsWelcomeRemindDialog extends Dialog {

    ClickMiaoBaiTiaoAdfFgsTextView content_tv;
    TextView topBtn;
    TextView bottomBtn;

    private OnListener onListener;

    public MiaoBaiTiaoAdfFgsWelcomeRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        content_tv.setText(StaticMiaoBaiTiaoAdfFgsUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
