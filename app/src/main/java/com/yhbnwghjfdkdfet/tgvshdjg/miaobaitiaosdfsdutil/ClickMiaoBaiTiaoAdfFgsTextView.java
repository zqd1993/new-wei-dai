...
public class ClickMiaoBaiTiaoAdfFgsTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickMiaoBaiTiaoAdfFgsTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
