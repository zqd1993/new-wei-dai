...
public class GodsListMiaoBaiTiaoAdfFgsMiaoBaiTiaoAdfFgsFragment extends BaseMiaoBaiTiaoAdfFgsFragment {
    ...
    public int getLayoutId() {
        return R.layout.fragment_goods_list_miao_bai_tiao_sdf;
    }
