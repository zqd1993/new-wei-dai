...
import com.yhbnwghjfdkdfet.tgvshdjg.miaobaitiaosdfsdutil.DownloadApkMiaoBaiTiaoAdfFgsUtil;
...
public class GoodsDetailsMiaoBaiTiaoAdfFgsMiaoBaiTiaoAdfFgsActivity extends BaseMiaoBaiTiaoAdfFgsActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_user_ysxy_miao_bai_tiao_sdf;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsMiaoBaiTiaoAdfFgsMiaoBaiTiaoAdfFgsActivity.this);
        ...
        DownloadApkMiaoBaiTiaoAdfFgsUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkMiaoBaiTiaoAdfFgsUtil.OnDownloadListener() {
            @Override
