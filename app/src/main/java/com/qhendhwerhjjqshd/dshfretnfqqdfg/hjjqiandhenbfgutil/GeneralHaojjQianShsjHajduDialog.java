...
public class GeneralHaojjQianShsjHajduDialog extends Dialog {
    ...
    public GeneralHaojjQianShsjHajduDialog(@NonNull Context context, String titleStr, String contentStr) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = View.inflate(context, R.layout.dialog_hao_jie_she_qtdhfery_general, null);
