...
public class StartPageHaojjQianShsjHajduDialog extends Dialog {
    ...
    public StartPageHaojjQianShsjHajduDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = View.inflate(context, R.layout.dialog_start_page_hao_jie_she_qtdhfery, null);
