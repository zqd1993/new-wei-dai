...
public class HaojjQianShsjHajduStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarHaojjQianShsjHajduView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarHaojjQianShsjHajduView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarHaojjQianShsjHajduView statusBarHaojjQianShsjHajduView = new StatusBarHaojjQianShsjHajduView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarHaojjQianShsjHajduView.setLayoutParams(params);
        statusBarHaojjQianShsjHajduView.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarHaojjQianShsjHajduView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarHaojjQianShsjHajduView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarHaojjQianShsjHajduView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarHaojjQianShsjHajduView statusBarHaojjQianShsjHajduView = new StatusBarHaojjQianShsjHajduView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarHaojjQianShsjHajduView.setLayoutParams(params);
        statusBarHaojjQianShsjHajduView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarHaojjQianShsjHajduView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarHaojjQianShsjHajduView;
    }
