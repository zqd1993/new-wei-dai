...
import com.qhendhwerhjjqshd.dshfretnfqqdfg.hjjqiandhenbfgutil.DownloadHaojjQianShsjHajduUtil;
...
public class HaojjQianShsjHajduShowGoogsInfoActivity extends RxAppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(HaojjQianShsjHajduShowGoogsInfoActivity.this);
        ...
        DownloadHaojjQianShsjHajduUtil.get().downloadApk(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadHaojjQianShsjHajduUtil.OnDownloadListener() {
            @Override
