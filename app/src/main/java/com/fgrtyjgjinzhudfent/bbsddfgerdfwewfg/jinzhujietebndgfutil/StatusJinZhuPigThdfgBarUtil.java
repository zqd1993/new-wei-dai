...
public class StatusJinZhuPigThdfgBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static JinZhuPigThdfgStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static JinZhuPigThdfgStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JinZhuPigThdfgStatusBarView jinZhuPigThdfgStatusBarView = new JinZhuPigThdfgStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        jinZhuPigThdfgStatusBarView.setLayoutParams(params);
        jinZhuPigThdfgStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        jinZhuPigThdfgStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return jinZhuPigThdfgStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static JinZhuPigThdfgStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JinZhuPigThdfgStatusBarView jinZhuPigThdfgStatusBarView = new JinZhuPigThdfgStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        jinZhuPigThdfgStatusBarView.setLayoutParams(params);
        jinZhuPigThdfgStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        jinZhuPigThdfgStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return jinZhuPigThdfgStatusBarView;
    }
