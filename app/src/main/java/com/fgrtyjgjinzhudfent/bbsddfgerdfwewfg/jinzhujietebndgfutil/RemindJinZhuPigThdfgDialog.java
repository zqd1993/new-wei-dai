...
public class RemindJinZhuPigThdfgDialog extends Dialog {
    ...
    public RemindJinZhuPigThdfgDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_jin_zhu_asf_pig_remind);
