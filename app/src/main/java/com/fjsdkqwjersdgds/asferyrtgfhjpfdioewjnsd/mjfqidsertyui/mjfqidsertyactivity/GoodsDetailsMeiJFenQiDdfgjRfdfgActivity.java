...
import com.fjsdkqwjersdgds.asferyrtgfhjpfdioewjnsd.mjfqidsertyutil.MeiJFenQiDdfgjRfdfgDownloadApkUtil;
...
public class GoodsDetailsMeiJFenQiDdfgjRfdfgActivity extends BaseMeiJFenQiDdfgjRfdfgActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsMeiJFenQiDdfgjRfdfgActivity.this);
        ...
        MeiJFenQiDdfgjRfdfgDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new MeiJFenQiDdfgjRfdfgDownloadApkUtil.OnDownloadListener() {
            @Override
