...
public class GoodsMeiJFenQiDdfgjRfdfgListAdapter extends BaseQuickAdapter<GoodsMeiJFenQiDdfgjRfdfgModel, BaseViewHolder> {

    private ItemClickListener itemClickListener;

    public GoodsMeiJFenQiDdfgjRfdfgListAdapter(int layoutResId, @Nullable List<GoodsMeiJFenQiDdfgjRfdfgModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, GoodsMeiJFenQiDdfgjRfdfgModel item) {
        ...
        Glide.with(mContext).load(MeiJFenQiDdfgjRfdfgRetrofitManager.API_BASE_URL + item.getProductLogo()).into(goodsPic);
    ...
    public interface ItemClickListener{
        void onItemClicked(GoodsMeiJFenQiDdfgjRfdfgModel item);
    }
}
