...
public class MeiJFenQiDdfgjRfdfgWelcomeRemindDialog extends Dialog {

    MeiJFenQiDdfgjRfdfgClickTextView content_tv;
    TextView topBtn;
    TextView bottomBtn;

    private OnListener onListener;

    public MeiJFenQiDdfgjRfdfgWelcomeRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_remind_mei_jie_sfgh_ewyfhg);
        ...
        content_tv.setText(StaticMeiJFenQiDdfgjRfdfgUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
