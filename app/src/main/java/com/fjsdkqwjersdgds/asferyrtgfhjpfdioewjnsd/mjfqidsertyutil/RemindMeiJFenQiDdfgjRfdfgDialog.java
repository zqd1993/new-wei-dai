...
public class RemindMeiJFenQiDdfgjRfdfgDialog extends Dialog {
    ...
    public RemindMeiJFenQiDdfgjRfdfgDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_mei_jie_sfgh_ewyfhg_remind);
