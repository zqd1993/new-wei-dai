...
public class JZhuJsiQIajsdnGeneralDialog extends Dialog {
    ...
    public JZhuJsiQIajsdnGeneralDialog(@NonNull Context context, String titleStr, String contentStr) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = View.inflate(context, R.layout.dialog_jin_zhu_jqi_djrufn_dfke_general, null);
