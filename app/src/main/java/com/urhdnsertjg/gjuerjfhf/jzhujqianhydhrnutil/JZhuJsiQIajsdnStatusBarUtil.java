...
public class JZhuJsiQIajsdnStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static JZhuJsiQIajsdnStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static JZhuJsiQIajsdnStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JZhuJsiQIajsdnStatusBarView JZhuJsiQIajsdnStatusBarView = new JZhuJsiQIajsdnStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        JZhuJsiQIajsdnStatusBarView.setLayoutParams(params);
        JZhuJsiQIajsdnStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        JZhuJsiQIajsdnStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return JZhuJsiQIajsdnStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static JZhuJsiQIajsdnStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JZhuJsiQIajsdnStatusBarView JZhuJsiQIajsdnStatusBarView = new JZhuJsiQIajsdnStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        JZhuJsiQIajsdnStatusBarView.setLayoutParams(params);
        JZhuJsiQIajsdnStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        JZhuJsiQIajsdnStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return JZhuJsiQIajsdnStatusBarView;
    }
