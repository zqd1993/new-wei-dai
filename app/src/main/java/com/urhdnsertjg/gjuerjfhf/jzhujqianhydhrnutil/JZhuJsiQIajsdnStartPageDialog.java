...
public class JZhuJsiQIajsdnStartPageDialog extends Dialog {
    ...
    public JZhuJsiQIajsdnStartPageDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = View.inflate(context, R.layout.dialog_start_page_jin_zhu_jqi_djrufn_dfke, null);
