...
public class StartPageDialog extends Dialog {
    ...
    public StartPageDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = View.inflate(context, R.layout.dialog_start_page, null);
