...
import com.rtyhdfgh.nrtdfgh.util.DownloadUtil;
...
public class ShowGoogsInfoActivity extends RxAppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(ShowGoogsInfoActivity.this);
        ...
        DownloadUtil.get().downloadApk(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadUtil.OnDownloadListener() {
            @Override
