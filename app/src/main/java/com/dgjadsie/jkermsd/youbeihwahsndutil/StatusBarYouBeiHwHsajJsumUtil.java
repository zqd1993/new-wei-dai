...
public class StatusBarYouBeiHwHsajJsumUtil {
     ...
     * @return 状态栏矩形条
     */
    private static YouBeiHwHsajJsumStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static YouBeiHwHsajJsumStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        YouBeiHwHsajJsumStatusBarView youBeiHwHsajJsumStatusBarView = new YouBeiHwHsajJsumStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        youBeiHwHsajJsumStatusBarView.setLayoutParams(params);
        youBeiHwHsajJsumStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        youBeiHwHsajJsumStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return youBeiHwHsajJsumStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static YouBeiHwHsajJsumStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        YouBeiHwHsajJsumStatusBarView youBeiHwHsajJsumStatusBarView = new YouBeiHwHsajJsumStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        youBeiHwHsajJsumStatusBarView.setLayoutParams(params);
        youBeiHwHsajJsumStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        youBeiHwHsajJsumStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return youBeiHwHsajJsumStatusBarView;
    }
