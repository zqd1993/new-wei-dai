...
import com.xiaoniukfiwe.ergfdhas.xiaoniuvwedfgutil.NewCodeXiaoNiuKuaiDownloadApkUtil;
...
public class NewCodeXiaoNiuKuaiGoodsDetailsNewCodeXiaoNiuKuaiActivity extends BaseNewCodeXiaoNiuKuaiActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(NewCodeXiaoNiuKuaiGoodsDetailsNewCodeXiaoNiuKuaiActivity.this);
        ...
        NewCodeXiaoNiuKuaiDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new NewCodeXiaoNiuKuaiDownloadApkUtil.OnDownloadListener() {
            @Override
