...
public class RuYiDaiKidunStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewRuYiDaiKidun createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewRuYiDaiKidun createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewRuYiDaiKidun statusBarViewRuYiDaiKidun = new StatusBarViewRuYiDaiKidun(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewRuYiDaiKidun.setLayoutParams(params);
        statusBarViewRuYiDaiKidun.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewRuYiDaiKidun.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewRuYiDaiKidun;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewRuYiDaiKidun createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewRuYiDaiKidun statusBarViewRuYiDaiKidun = new StatusBarViewRuYiDaiKidun(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewRuYiDaiKidun.setLayoutParams(params);
        statusBarViewRuYiDaiKidun.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewRuYiDaiKidun.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewRuYiDaiKidun;
    }
