...
public class RongjieSfFgdfGoodsListAdapter extends BaseQuickAdapter<RongjieSfFgdfGoodsModel, BaseViewHolder> {

    private ItemClickListener itemClickListener;

    public RongjieSfFgdfGoodsListAdapter(int layoutResId, @Nullable List<RongjieSfFgdfGoodsModel> data) {
