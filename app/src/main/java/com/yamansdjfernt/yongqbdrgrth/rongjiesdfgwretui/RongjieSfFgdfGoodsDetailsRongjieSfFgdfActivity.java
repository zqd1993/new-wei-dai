...
import com.yamansdjfernt.yongqbdrgrth.rongjiesdfgwretutil.DownloadApkUtilRongjieSfFgdf;
...
public class RongjieSfFgdfGoodsDetailsRongjieSfFgdfActivity extends BaseRongjieSfFgdfActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(RongjieSfFgdfGoodsDetailsRongjieSfFgdfActivity.this);
        ...
        DownloadApkUtilRongjieSfFgdf.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilRongjieSfFgdf.OnDownloadListener() {
            @Override
