...
import com.yamansdjfernt.yongqbdrgrth.rongjiesdfgwretui.RongjieSfFgdfMainRongjieSfFgdfActivity;
...
public class MainRongjieSfFgdfFragment extends BaseRongjieSfFgdfFragment {
    ...
    public int getLayoutId() {
        return R.layout.fragment_main_rong_jie_sdf_brty;
    }
    ...
    public void initListener() {
        ...
        moreTv.setOnClickListener(v -> {
            ((RongjieSfFgdfMainRongjieSfFgdfActivity)getActivity()).changePage();
        });
    }
