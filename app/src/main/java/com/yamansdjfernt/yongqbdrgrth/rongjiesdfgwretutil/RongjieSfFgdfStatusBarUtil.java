...
public class RongjieSfFgdfStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewRongjieSfFgdf createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewRongjieSfFgdf createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewRongjieSfFgdf statusBarViewRongjieSfFgdf = new StatusBarViewRongjieSfFgdf(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewRongjieSfFgdf.setLayoutParams(params);
        statusBarViewRongjieSfFgdf.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewRongjieSfFgdf.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewRongjieSfFgdf;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewRongjieSfFgdf createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewRongjieSfFgdf statusBarViewRongjieSfFgdf = new StatusBarViewRongjieSfFgdf(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewRongjieSfFgdf.setLayoutParams(params);
        statusBarViewRongjieSfFgdf.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewRongjieSfFgdf.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewRongjieSfFgdf;
    }
