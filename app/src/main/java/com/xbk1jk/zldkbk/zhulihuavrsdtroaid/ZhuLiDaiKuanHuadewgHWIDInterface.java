...
public interface ZhuLiDaiKuanHuadewgHWIDInterface extends IInterface {
    String getIDs();

    boolean getBoos();

    public final class MiaoBaiTiaoAdfFgsHWID implements ZhuLiDaiKuanHuadewgHWIDInterface {
        private IBinder iBinder;
        private Context context;

        public MiaoBaiTiaoAdfFgsHWID(IBinder ib, Context ct) {
            iBinder = ib;
            context = ct;
        }
