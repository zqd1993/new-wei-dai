...
public class ZhuLiDaiKuanHuadewgDevicesIDsHelper {
    private AppIdsUpdater _listener;

    public ZhuLiDaiKuanHuadewgDevicesIDsHelper(AppIdsUpdater callback) {
        _listener = callback;
    }
    ...
    public void getOAID(Context mcontext) {
        ...
        if ("ASUS".equals(manufacturer)) {
            ...
            oaid = new ZhuLiDaiKuanHuadewgVivoDeviceIDHelper(mcontext).getOaid();

        } else if ("XIAOMI".equals(manufacturer)) {

            oaid = new ZhuLiDaiKuanHuadewgXiaomiDeviceIDHelper(mcontext).getOAID();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                if ("OPPO".equals(manufacturerm)) {
                    new ZhuLiDaiKuanHuadewgOppoDeviceIDHelper(context).getID(_listener);
                } else if ("HUAWEI".equals(manufacturerm)) {
                    new ZhuLiDaiKuanHuadewgHWDeviceIDHelper(context).getHWID(_listener);
