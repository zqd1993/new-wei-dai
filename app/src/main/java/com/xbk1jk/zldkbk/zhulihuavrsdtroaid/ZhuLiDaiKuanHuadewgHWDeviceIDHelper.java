...
public class ZhuLiDaiKuanHuadewgHWDeviceIDHelper {
    private Context mContext;
    public final LinkedBlockingQueue<IBinder> linkedBlockingQueue = new LinkedBlockingQueue(1);

    public ZhuLiDaiKuanHuadewgHWDeviceIDHelper(Context ctx) {
        mContext = ctx;
    }

    public void getHWID(ZhuLiDaiKuanHuadewgDevicesIDsHelper.AppIdsUpdater _listener) {
        try {
        ...
        if (isBin) {
            try {
                ...
                ZhuLiDaiKuanHuadewgHWIDInterface.MiaoBaiTiaoAdfFgsHWID hwID = new ZhuLiDaiKuanHuadewgHWIDInterface.MiaoBaiTiaoAdfFgsHWID(iBinder, mContext);
