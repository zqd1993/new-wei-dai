...
import com.xbk1jk.zldkbk.zhulihuavrsdtrui.MainZhuLiDaiKuanHuadewgActivity;
...
public class MainZhuLiDaiKuanHuadewgFragment extends BaseZhuLiDaiKuanHuadewgFragment {
    ...
    public int getLayoutId() {
        return R.layout.fragment_zhu_li_dai_kuan_hua_setg_sert_main;
    }
    ...
    public void initListener() {
        ...
        more_tv.setOnClickListener(v -> {
            ((MainZhuLiDaiKuanHuadewgActivity)getActivity()).changePage();
        });
    }
