...
public class RemindZhuLiDaiKuanHuadewgDialog extends Dialog {
    ...
    public RemindZhuLiDaiKuanHuadewgDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_zhu_li_dai_kuan_hua_setg_sert_remind);
