...
public class YouJieSDjdfiWelcomeRemindDialog extends Dialog {

    YouJieSDjdfiClickTextView content_tv;
    TextView topBtn;
    TextView bottomBtn;

    private OnListener onListener;

    public YouJieSDjdfiWelcomeRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_remind_you_jie_iejbvr);
        ...
        content_tv.setText(StaticYouJieSDjdfiUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
