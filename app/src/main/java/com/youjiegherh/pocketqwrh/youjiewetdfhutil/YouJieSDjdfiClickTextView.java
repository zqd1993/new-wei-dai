...
public class YouJieSDjdfiClickTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public YouJieSDjdfiClickTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
