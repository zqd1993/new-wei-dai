...
public class YouJieSDjdfiStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static YouJieSDjdfiStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static YouJieSDjdfiStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        YouJieSDjdfiStatusBarView youJieSDjdfiStatusBarView = new YouJieSDjdfiStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        youJieSDjdfiStatusBarView.setLayoutParams(params);
        youJieSDjdfiStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        youJieSDjdfiStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return youJieSDjdfiStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static YouJieSDjdfiStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        YouJieSDjdfiStatusBarView youJieSDjdfiStatusBarView = new YouJieSDjdfiStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        youJieSDjdfiStatusBarView.setLayoutParams(params);
        youJieSDjdfiStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        youJieSDjdfiStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return youJieSDjdfiStatusBarView;
    }
