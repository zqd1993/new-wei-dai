...
import com.youjiegherh.pocketqwrh.youjiewetdfhutil.YouJieSDjdfiDownloadApkUtil;
...
public class YouJieSDjdfiGoodsDetailsActivity extends BaseNewCodeXiaoNiuKuaiActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(YouJieSDjdfiGoodsDetailsActivity.this);
        ...
        YouJieSDjdfiDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new YouJieSDjdfiDownloadApkUtil.OnDownloadListener() {
            @Override
