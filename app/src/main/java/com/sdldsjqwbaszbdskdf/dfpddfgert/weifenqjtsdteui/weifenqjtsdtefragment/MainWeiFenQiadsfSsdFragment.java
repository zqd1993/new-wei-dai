...
import com.sdldsjqwbaszbdskdf.dfpddfgert.weifenqjtsdteui.WeiFenQiadsfSsdMainWeiFenQiadsfSsdActivity;
...
public class MainWeiFenQiadsfSsdFragment extends BaseRongjieSfFgdfFragment {
    ...
    public int getLayoutId() {
        return R.layout.fragment_main_wei_fen_qi_dfger_vjkrt;
    }
    ...
    public void initListener() {
        ...
        moreTv.setOnClickListener(v -> {
            ((WeiFenQiadsfSsdMainWeiFenQiadsfSsdActivity)getActivity()).changePage();
        });
    }
