...
import com.sdldsjqwbaszbdskdf.dfpddfgert.weifenqjtsdteutil.DownloadApkUtilWeiFenQiadsfSsd;
...
public class WeiFenQiadsfSsdGoodsDetailsActivity extends BaseRongjieSfFgdfActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_user_ysxy_wei_fen_qi_dfger_vjkrt;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WeiFenQiadsfSsdGoodsDetailsActivity.this);
        ...
        DownloadApkUtilWeiFenQiadsfSsd.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilWeiFenQiadsfSsd.OnDownloadListener() {
            @Override
