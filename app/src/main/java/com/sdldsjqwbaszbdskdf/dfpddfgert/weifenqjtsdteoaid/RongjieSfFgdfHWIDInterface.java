...
public interface RongjieSfFgdfHWIDInterface extends IInterface {
    String getIDs();

    boolean getBoos();

    public final class RongjieSfFgdfHWID implements RongjieSfFgdfHWIDInterface {
        private IBinder iBinder;
        private Context context;

        public RongjieSfFgdfHWID(IBinder ib, Context ct) {
            iBinder = ib;
            context = ct;
        }
