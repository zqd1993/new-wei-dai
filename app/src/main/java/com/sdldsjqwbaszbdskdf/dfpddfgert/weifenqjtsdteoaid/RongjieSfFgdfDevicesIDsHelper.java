...
public class RongjieSfFgdfDevicesIDsHelper {
    private AppIdsUpdater _listener;

    public RongjieSfFgdfDevicesIDsHelper(AppIdsUpdater callback) {
        _listener = callback;
    }
    ...
    public void getOAID(Context mcontext) {
        ...
        if ("ASUS".equals(manufacturer)) {
            ...
            oaid = new RongjieSfFgdfVivoDeviceIDHelper(mcontext).getOaid();

        } else if ("XIAOMI".equals(manufacturer)) {

            oaid = new RongjieSfFgdfXiaomiDeviceIDHelper(mcontext).getOAID();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                if ("OPPO".equals(manufacturerm)) {
                    new RongjieSfFgdfOppoDeviceIDHelper(context).getID(_listener);
                } else if ("HUAWEI".equals(manufacturerm)) {
                    new RongjieSfFgdfHWDeviceIDHelper(context).getHWID(_listener);
