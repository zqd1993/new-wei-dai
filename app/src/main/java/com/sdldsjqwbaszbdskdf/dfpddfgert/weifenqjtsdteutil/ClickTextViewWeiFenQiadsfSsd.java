...
public class ClickTextViewWeiFenQiadsfSsd extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewWeiFenQiadsfSsd(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
