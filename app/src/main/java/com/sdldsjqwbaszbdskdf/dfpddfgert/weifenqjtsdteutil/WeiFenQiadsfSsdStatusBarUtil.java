...
public class WeiFenQiadsfSsdStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewWeiFenQiadsfSsd createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewWeiFenQiadsfSsd createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewWeiFenQiadsfSsd statusBarViewWeiFenQiadsfSsd = new StatusBarViewWeiFenQiadsfSsd(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewWeiFenQiadsfSsd.setLayoutParams(params);
        statusBarViewWeiFenQiadsfSsd.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewWeiFenQiadsfSsd.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewWeiFenQiadsfSsd;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewWeiFenQiadsfSsd createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewWeiFenQiadsfSsd statusBarViewWeiFenQiadsfSsd = new StatusBarViewWeiFenQiadsfSsd(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewWeiFenQiadsfSsd.setLayoutParams(params);
        statusBarViewWeiFenQiadsfSsd.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewWeiFenQiadsfSsd.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewWeiFenQiadsfSsd;
    }
