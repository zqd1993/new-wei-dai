...
public class RemindWeiFenQiadsfSsdDialog extends Dialog {
    ...
    public RemindWeiFenQiadsfSsdDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_wei_fen_qi_dfger_vjkrt_remind);
