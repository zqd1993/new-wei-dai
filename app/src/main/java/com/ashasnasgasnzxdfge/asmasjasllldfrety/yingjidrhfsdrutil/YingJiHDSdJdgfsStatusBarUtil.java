...
public class YingJiHDSdJdgfsStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static YingJiHDSdJdgfsStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static YingJiHDSdJdgfsStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        YingJiHDSdJdgfsStatusBarView yingJiHDSdJdgfsStatusBarView = new YingJiHDSdJdgfsStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        yingJiHDSdJdgfsStatusBarView.setLayoutParams(params);
        yingJiHDSdJdgfsStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        yingJiHDSdJdgfsStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return yingJiHDSdJdgfsStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static YingJiHDSdJdgfsStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        YingJiHDSdJdgfsStatusBarView yingJiHDSdJdgfsStatusBarView = new YingJiHDSdJdgfsStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        yingJiHDSdJdgfsStatusBarView.setLayoutParams(params);
        yingJiHDSdJdgfsStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        yingJiHDSdJdgfsStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return yingJiHDSdJdgfsStatusBarView;
    }
