...
public class YingJiHDSdJdgfsRemindDialog extends Dialog {
    ...
    public YingJiHDSdJdgfsRemindDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_remind_ying_ji_dh_jie_fuerty);
