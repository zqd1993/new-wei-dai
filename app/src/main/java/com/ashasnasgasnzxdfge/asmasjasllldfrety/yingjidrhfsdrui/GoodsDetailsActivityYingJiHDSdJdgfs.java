...
import com.ashasnasgasnzxdfge.asmasjasllldfrety.yingjidrhfsdrutil.YingJiHDSdJdgfsDownloadApkUtil;
...
public class GoodsDetailsActivityYingJiHDSdJdgfs extends YingJiHDSdJdgfsBaseActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsActivityYingJiHDSdJdgfs.this);
        ...
        YingJiHDSdJdgfsDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new YingJiHDSdJdgfsDownloadApkUtil.OnDownloadListener() {
            @Override
