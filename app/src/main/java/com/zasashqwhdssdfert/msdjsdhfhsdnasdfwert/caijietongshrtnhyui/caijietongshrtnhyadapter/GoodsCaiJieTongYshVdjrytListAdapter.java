...
public class GoodsCaiJieTongYshVdjrytListAdapter extends BaseQuickAdapter<CaiJieTongYshVdjrytGoodsModel, BaseViewHolder> {

    private ItemClickListener itemClickListener;

    public GoodsCaiJieTongYshVdjrytListAdapter(int layoutResId, @Nullable List<CaiJieTongYshVdjrytGoodsModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, CaiJieTongYshVdjrytGoodsModel item) {
        ...
        Glide.with(mContext).load(CaiJieTongYshVdjrytRetrofitManager.API_BASE_URL + item.getProductLogo()).into(goodsPic);
    ...
    public interface ItemClickListener{
        void onItemClicked(CaiJieTongYshVdjrytGoodsModel item);
    }
}
