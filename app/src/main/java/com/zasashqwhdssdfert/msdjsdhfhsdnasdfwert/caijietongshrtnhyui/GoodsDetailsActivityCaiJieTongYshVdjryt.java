...
import com.zasashqwhdssdfert.msdjsdhfhsdnasdfwert.caijietongshrtnhyutil.CaiJieTongYshVdjrytDownloadApkUtil;
...
public class GoodsDetailsActivityCaiJieTongYshVdjryt extends CaiJieTongYshVdjrytBaseActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsActivityCaiJieTongYshVdjryt.this);
        ...
        CaiJieTongYshVdjrytDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new CaiJieTongYshVdjrytDownloadApkUtil.OnDownloadListener() {
            @Override
