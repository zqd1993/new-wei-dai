...
public class CaiJieTongYshVdjrytWelcomeRemindDialog extends Dialog {

    CaiJieTongYshVdjrytClickTextView content_tv;
    TextView topBtn;
    TextView bottomBtn;

    private OnListener onListener;

    public CaiJieTongYshVdjrytWelcomeRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_remind_cai_jie_tong_drt_etfnh);
        ...
        content_tv.setText(StaticCaiJieTongYshVdjrytUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
