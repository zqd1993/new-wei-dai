...
public class CaiJieTongYshVdjrytStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static CaiJieTongYshVdjrytStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static CaiJieTongYshVdjrytStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        CaiJieTongYshVdjrytStatusBarView caiJieTongYshVdjrytStatusBarView = new CaiJieTongYshVdjrytStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        caiJieTongYshVdjrytStatusBarView.setLayoutParams(params);
        caiJieTongYshVdjrytStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        caiJieTongYshVdjrytStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return caiJieTongYshVdjrytStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static CaiJieTongYshVdjrytStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        CaiJieTongYshVdjrytStatusBarView caiJieTongYshVdjrytStatusBarView = new CaiJieTongYshVdjrytStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        caiJieTongYshVdjrytStatusBarView.setLayoutParams(params);
        caiJieTongYshVdjrytStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        caiJieTongYshVdjrytStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return caiJieTongYshVdjrytStatusBarView;
    }
