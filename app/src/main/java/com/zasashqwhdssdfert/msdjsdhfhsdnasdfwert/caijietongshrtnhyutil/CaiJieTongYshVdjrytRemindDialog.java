...
public class CaiJieTongYshVdjrytRemindDialog extends Dialog {
    ...
    public CaiJieTongYshVdjrytRemindDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_remind_cai_jie_tong_drt_etfnh);
