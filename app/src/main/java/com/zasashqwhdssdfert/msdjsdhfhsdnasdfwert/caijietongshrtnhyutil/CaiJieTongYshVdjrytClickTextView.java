...
public class CaiJieTongYshVdjrytClickTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public CaiJieTongYshVdjrytClickTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
