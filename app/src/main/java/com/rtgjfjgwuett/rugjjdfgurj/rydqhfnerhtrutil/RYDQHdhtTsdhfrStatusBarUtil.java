...
public class RYDQHdhtTsdhfrStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewRYDQHdhtTsdhfr createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewRYDQHdhtTsdhfr createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewRYDQHdhtTsdhfr statusBarViewRYDQHdhtTsdhfr = new StatusBarViewRYDQHdhtTsdhfr(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewRYDQHdhtTsdhfr.setLayoutParams(params);
        statusBarViewRYDQHdhtTsdhfr.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewRYDQHdhtTsdhfr.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewRYDQHdhtTsdhfr;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewRYDQHdhtTsdhfr createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewRYDQHdhtTsdhfr statusBarViewRYDQHdhtTsdhfr = new StatusBarViewRYDQHdhtTsdhfr(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewRYDQHdhtTsdhfr.setLayoutParams(params);
        statusBarViewRYDQHdhtTsdhfr.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewRYDQHdhtTsdhfr.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewRYDQHdhtTsdhfr;
    }
