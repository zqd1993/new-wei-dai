...
public class RemindRYDQHdhtTsdhfrDialog extends Dialog {
    ...
    public RemindRYDQHdhtTsdhfrDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_rydqh_fdhr_yrtehy_remind);
