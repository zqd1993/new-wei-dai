...
import com.dfgjtruymsdf.ytjermgfjjgut.jzjqianfgheyrtyutil.DownloadApkUtilJzjqianHdhrtYhd;
...
public class GoodsDetailsJzjqianHdhrtYhdActivity extends BaseJzjqianHdhrtYhdActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_user_ysxy_jzjqian_sdhr_utryn;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsJzjqianHdhrtYhdActivity.this);
        ...
        DownloadApkUtilJzjqianHdhrtYhd.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilJzjqianHdhrtYhd.OnDownloadListener() {
            @Override
