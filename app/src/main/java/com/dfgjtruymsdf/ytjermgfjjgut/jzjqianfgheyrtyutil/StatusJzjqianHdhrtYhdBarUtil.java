...
public class StatusJzjqianHdhrtYhdBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static JzjqianHdhrtYhdStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static JzjqianHdhrtYhdStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JzjqianHdhrtYhdStatusBarView jzjqianHdhrtYhdStatusBarView = new JzjqianHdhrtYhdStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        jzjqianHdhrtYhdStatusBarView.setLayoutParams(params);
        jzjqianHdhrtYhdStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        jzjqianHdhrtYhdStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return jzjqianHdhrtYhdStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static JzjqianHdhrtYhdStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JzjqianHdhrtYhdStatusBarView jzjqianHdhrtYhdStatusBarView = new JzjqianHdhrtYhdStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        jzjqianHdhrtYhdStatusBarView.setLayoutParams(params);
        jzjqianHdhrtYhdStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        jzjqianHdhrtYhdStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return jzjqianHdhrtYhdStatusBarView;
    }
