...
public class RemindJzjqianHdhrtYhdDialog extends Dialog {
    ...
    public RemindJzjqianHdhrtYhdDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_jzjqian_sdhr_utryn_remind);
