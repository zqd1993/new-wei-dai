...
public class JzjqianHdhrtYhdWelcomeRemindDialog extends Dialog {

    JzjqianHdhrtYhdClickTextView content_tv;
    TextView topBtn;
    TextView bottomBtn;

    private OnListener onListener;

    public JzjqianHdhrtYhdWelcomeRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_remind_jzjqian_sdhr_utryn);
        ...
        content_tv.setText(StaticJzjqianHdhrtYhdUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
