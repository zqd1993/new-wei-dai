...
public class RemindBaseQuHuaDjdfuVdhrDialog extends Dialog {
    ...
    public RemindBaseQuHuaDjdfuVdhrDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_qu_hua_hua_erf_engh_remind);
