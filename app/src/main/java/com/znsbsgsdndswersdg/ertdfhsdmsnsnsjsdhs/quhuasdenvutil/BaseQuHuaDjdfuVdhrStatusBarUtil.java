...
public class BaseQuHuaDjdfuVdhrStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BaseQuHuaDjdfuVdhrStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BaseQuHuaDjdfuVdhrStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BaseQuHuaDjdfuVdhrStatusBarView baseQuHuaDjdfuVdhrStatusBarView = new BaseQuHuaDjdfuVdhrStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        baseQuHuaDjdfuVdhrStatusBarView.setLayoutParams(params);
        baseQuHuaDjdfuVdhrStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        baseQuHuaDjdfuVdhrStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return baseQuHuaDjdfuVdhrStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BaseQuHuaDjdfuVdhrStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BaseQuHuaDjdfuVdhrStatusBarView baseQuHuaDjdfuVdhrStatusBarView = new BaseQuHuaDjdfuVdhrStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        baseQuHuaDjdfuVdhrStatusBarView.setLayoutParams(params);
        baseQuHuaDjdfuVdhrStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        baseQuHuaDjdfuVdhrStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return baseQuHuaDjdfuVdhrStatusBarView;
    }
