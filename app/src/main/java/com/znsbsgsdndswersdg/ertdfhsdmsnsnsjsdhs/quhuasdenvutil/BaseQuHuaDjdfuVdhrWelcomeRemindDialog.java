...
public class BaseQuHuaDjdfuVdhrWelcomeRemindDialog extends Dialog {

    BaseQuHuaDjdfuVdhrClickTextView content_tv;
    TextView topBtn;
    TextView bottomBtn;

    private OnListener onListener;

    public BaseQuHuaDjdfuVdhrWelcomeRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_remind_qu_hua_hua_erf_engh);
        ...
        content_tv.setText(StaticBaseQuHuaDjdfuVdhrUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
