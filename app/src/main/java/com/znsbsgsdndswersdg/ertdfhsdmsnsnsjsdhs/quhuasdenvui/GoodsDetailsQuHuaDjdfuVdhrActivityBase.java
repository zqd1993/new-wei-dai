...
public class GoodsDetailsQuHuaDjdfuVdhrActivityBase extends BaseBaseQuHuaDjdfuVdhrActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ...
        BaseQuHuaDjdfuVdhrDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new BaseQuHuaDjdfuVdhrDownloadApkUtil.OnDownloadListener() {
            @Override
