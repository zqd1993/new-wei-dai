...
public class JiuJiHdfnfhGDhsdStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static JiuJiHdfnfhGDhsdStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static JiuJiHdfnfhGDhsdStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JiuJiHdfnfhGDhsdStatusBarView jiuJiHdfnfhGDhsdStatusBarView = new JiuJiHdfnfhGDhsdStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        jiuJiHdfnfhGDhsdStatusBarView.setLayoutParams(params);
        jiuJiHdfnfhGDhsdStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        jiuJiHdfnfhGDhsdStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return jiuJiHdfnfhGDhsdStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static JiuJiHdfnfhGDhsdStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JiuJiHdfnfhGDhsdStatusBarView jiuJiHdfnfhGDhsdStatusBarView = new JiuJiHdfnfhGDhsdStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        jiuJiHdfnfhGDhsdStatusBarView.setLayoutParams(params);
        jiuJiHdfnfhGDhsdStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        jiuJiHdfnfhGDhsdStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return jiuJiHdfnfhGDhsdStatusBarView;
    }
