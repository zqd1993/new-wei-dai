...
public class RemindJiuJiHdfnfhGDhsdDialog extends Dialog {
    ...
    public RemindJiuJiHdfnfhGDhsdDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_jiu_ji_fdher_reytjyh_remind);
