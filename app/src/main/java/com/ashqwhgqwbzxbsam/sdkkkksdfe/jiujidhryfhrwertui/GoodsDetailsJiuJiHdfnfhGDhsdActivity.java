...
import com.ashqwhgqwbzxbsam.sdkkkksdfe.jiujidhryfhrwertutil.JiuJiHdfnfhGDhsdDownloadApkUtil;
...
public class GoodsDetailsJiuJiHdfnfhGDhsdActivity extends BaseJiuJiHdfnfhGDhsdActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsJiuJiHdfnfhGDhsdActivity.this);
        ...
        JiuJiHdfnfhGDhsdDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new JiuJiHdfnfhGDhsdDownloadApkUtil.OnDownloadListener() {
            @Override
