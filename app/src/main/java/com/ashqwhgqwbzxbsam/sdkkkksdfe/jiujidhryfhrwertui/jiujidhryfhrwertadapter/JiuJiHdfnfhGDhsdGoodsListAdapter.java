...
public class JiuJiHdfnfhGDhsdGoodsListAdapter extends BaseQuickAdapter<GoodsJiuJiHdfnfhGDhsdModel, BaseViewHolder> {

    private ItemClickListener itemClickListener;

    public JiuJiHdfnfhGDhsdGoodsListAdapter(int layoutResId, @Nullable List<GoodsJiuJiHdfnfhGDhsdModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, GoodsJiuJiHdfnfhGDhsdModel item) {
        ...
        Glide.with(mContext).load(RetrofitJiuJiHdfnfhGDhsdManager.API_BASE_URL + item.getProductLogo()).into(goodsPic);
    ...
    public interface ItemClickListener{
        void onItemClicked(GoodsJiuJiHdfnfhGDhsdModel item);
    }
}
