...
public class RemindWuYouJieShdfnFjfuirDialog extends Dialog {
    ...
    public RemindWuYouJieShdfnFjfuirDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_wu_you_jie_jdf_eryj_remind);
