...
import com.wuyousdhrnyhddsdg.yfgnwertyjsfgh.wuyoufdghtyfsutil.WuYouJieShdfnFjfuirDownloadApkUtil;
...
public class GoodsDetailsWuYouJieShdfnFjfuirActivity extends BaseWuYouJieShdfnFjfuirActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsWuYouJieShdfnFjfuirActivity.this);
        ...
        WuYouJieShdfnFjfuirDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new WuYouJieShdfnFjfuirDownloadApkUtil.OnDownloadListener() {
            @Override
