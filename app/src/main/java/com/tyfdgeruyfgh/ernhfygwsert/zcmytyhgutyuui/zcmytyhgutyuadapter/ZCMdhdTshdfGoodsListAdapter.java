...
public class ZCMdhdTshdfGoodsListAdapter extends BaseQuickAdapter<GoodsZCMdhdTshdfModel, BaseViewHolder> {

    private ItemClickListener itemClickListener;

    public ZCMdhdTshdfGoodsListAdapter(int layoutResId, @Nullable List<GoodsZCMdhdTshdfModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, GoodsZCMdhdTshdfModel item) {
        ...
        Glide.with(mContext).load(RetrofitZCMdhdTshdfManager.API_BASE_URL + item.getProductLogo()).into(goodsPic);
    ...
    public interface ItemClickListener{
        void onItemClicked(GoodsZCMdhdTshdfModel item);
    }
}
