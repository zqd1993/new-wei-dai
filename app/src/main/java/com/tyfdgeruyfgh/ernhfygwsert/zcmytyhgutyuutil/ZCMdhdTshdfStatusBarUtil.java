...
public class ZCMdhdTshdfStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static ZCMdhdTshdfStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static ZCMdhdTshdfStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        ZCMdhdTshdfStatusBarView ZCMdhdTshdfStatusBarView = new ZCMdhdTshdfStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        ZCMdhdTshdfStatusBarView.setLayoutParams(params);
        ZCMdhdTshdfStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        ZCMdhdTshdfStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return ZCMdhdTshdfStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static ZCMdhdTshdfStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        ZCMdhdTshdfStatusBarView ZCMdhdTshdfStatusBarView = new ZCMdhdTshdfStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        ZCMdhdTshdfStatusBarView.setLayoutParams(params);
        ZCMdhdTshdfStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        ZCMdhdTshdfStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return ZCMdhdTshdfStatusBarView;
    }
