...
public class ZCMdhdTshdfWelcomeRemindDialog extends Dialog {

    ZCMdhdTshdfClickTextView content_tv;
    TextView topBtn;
    TextView bottomBtn;

    private OnListener onListener;

    public ZCMdhdTshdfWelcomeRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_remind_zcm_fhgetr_tqttry);
        ...
        content_tv.setText(StaticZCMdhdTshdfUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
