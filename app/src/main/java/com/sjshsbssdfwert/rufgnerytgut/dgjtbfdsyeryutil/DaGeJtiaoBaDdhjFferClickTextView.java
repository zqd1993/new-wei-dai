...
public class DaGeJtiaoBaDdhjFferClickTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public DaGeJtiaoBaDdhjFferClickTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
