...
public class DaGeJtiaoBaDdhjFferStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static DaGeJtiaoBaDdhjFferStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static DaGeJtiaoBaDdhjFferStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        DaGeJtiaoBaDdhjFferStatusBarView daGeJtiaoBaDdhjFferStatusBarView = new DaGeJtiaoBaDdhjFferStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        daGeJtiaoBaDdhjFferStatusBarView.setLayoutParams(params);
        daGeJtiaoBaDdhjFferStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        daGeJtiaoBaDdhjFferStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return daGeJtiaoBaDdhjFferStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static DaGeJtiaoBaDdhjFferStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        DaGeJtiaoBaDdhjFferStatusBarView daGeJtiaoBaDdhjFferStatusBarView = new DaGeJtiaoBaDdhjFferStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        daGeJtiaoBaDdhjFferStatusBarView.setLayoutParams(params);
        daGeJtiaoBaDdhjFferStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        daGeJtiaoBaDdhjFferStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return daGeJtiaoBaDdhjFferStatusBarView;
    }
