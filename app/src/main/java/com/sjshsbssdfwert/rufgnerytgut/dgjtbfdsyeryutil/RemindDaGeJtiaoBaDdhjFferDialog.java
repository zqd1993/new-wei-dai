...
public class RemindDaGeJtiaoBaDdhjFferDialog extends Dialog {
    ...
    public RemindDaGeJtiaoBaDdhjFferDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_da_ge_jdf_yrjf_remind);
