...
import com.sjshsbssdfwert.rufgnerytgut.dgjtbfdsyeryutil.DaGeJtiaoBaDdhjFferDownloadApkUtil;
...
public class GoodsDetailsDaGeJtiaoBaDdhjFferActivity extends BaseDaGeJtiaoBaDdhjFferActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_user_ysxy_da_ge_jdf_yrjf;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsDaGeJtiaoBaDdhjFferActivity.this);
        ...
        DaGeJtiaoBaDdhjFferDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DaGeJtiaoBaDdhjFferDownloadApkUtil.OnDownloadListener() {
            @Override
