...
import com.dryghsfzhaocaimao.regfhseradfert.zhaocaimaowegutil.ZhaoCaiCatKfrtDownloadApkUtil;
...
public class ZhaoCaiCatKfrtGoodsDetailsZhaoCaiCatKfrtActivity extends BaseZhaoCaiCatKfrtActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_user_ysxy_zhao_cai_mao_dfget;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(ZhaoCaiCatKfrtGoodsDetailsZhaoCaiCatKfrtActivity.this);
        ...
        ZhaoCaiCatKfrtDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new ZhaoCaiCatKfrtDownloadApkUtil.OnDownloadListener() {
            @Override
