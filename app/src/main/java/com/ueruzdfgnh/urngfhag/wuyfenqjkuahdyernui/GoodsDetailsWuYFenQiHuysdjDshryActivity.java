...
import com.ueruzdfgnh.urngfhag.wuyfenqjkuahdyernutil.WuYFenQiHuysdjDshryDownloadApkUtil;
...
public class GoodsDetailsWuYFenQiHuysdjDshryActivity extends BaseWuYFenQiHuysdjDshryActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_user_ysxy_wu_yfen_qijai_dfjrt;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsWuYFenQiHuysdjDshryActivity.this);
        ...
        WuYFenQiHuysdjDshryDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new WuYFenQiHuysdjDshryDownloadApkUtil.OnDownloadListener() {
            @Override
