...
public class RemindWuYFenQiHuysdjDshryDialog extends Dialog {
    ...
    public RemindWuYFenQiHuysdjDshryDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_wu_yfen_qijai_dfjrt_remind);
