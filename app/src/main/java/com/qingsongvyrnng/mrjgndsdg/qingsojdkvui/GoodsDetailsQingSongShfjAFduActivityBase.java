...
import com.qingsongvyrnng.mrjgndsdg.qingsojdkvutil.BaseQingSongShfjAFduDownloadApkUtil;
...
public class GoodsDetailsQingSongShfjAFduActivityBase extends BaseBaseQingSongShfjAFduActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_user_ysxy_qing_song_sh_udj;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsQingSongShfjAFduActivityBase.this);
        ...
        BaseQingSongShfjAFduDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new BaseQingSongShfjAFduDownloadApkUtil.OnDownloadListener() {
            @Override
