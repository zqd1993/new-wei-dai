...
public class BaseQingSongShfjAFduStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BaseQingSongShfjAFduStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BaseQingSongShfjAFduStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BaseQingSongShfjAFduStatusBarView baseQingSongShfjAFduStatusBarView = new BaseQingSongShfjAFduStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        baseQingSongShfjAFduStatusBarView.setLayoutParams(params);
        baseQingSongShfjAFduStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        baseQingSongShfjAFduStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return baseQingSongShfjAFduStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BaseQingSongShfjAFduStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BaseQingSongShfjAFduStatusBarView baseQingSongShfjAFduStatusBarView = new BaseQingSongShfjAFduStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        baseQingSongShfjAFduStatusBarView.setLayoutParams(params);
        baseQingSongShfjAFduStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        baseQingSongShfjAFduStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return baseQingSongShfjAFduStatusBarView;
    }
