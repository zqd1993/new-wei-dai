...
public class BaseQingSongShfjAFduClickTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public BaseQingSongShfjAFduClickTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
