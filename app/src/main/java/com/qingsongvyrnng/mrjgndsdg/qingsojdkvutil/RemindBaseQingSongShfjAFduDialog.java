...
public class RemindBaseQingSongShfjAFduDialog extends Dialog {
    ...
    public RemindBaseQingSongShfjAFduDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_qing_song_sh_udj_remind);
