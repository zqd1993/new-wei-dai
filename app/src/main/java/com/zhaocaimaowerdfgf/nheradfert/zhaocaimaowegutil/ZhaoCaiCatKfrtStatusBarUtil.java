...
public class ZhaoCaiCatKfrtStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static ZhaoCaiCatKfrtStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static ZhaoCaiCatKfrtStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        ZhaoCaiCatKfrtStatusBarView zhaoCaiCatKfrtStatusBarView = new ZhaoCaiCatKfrtStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        zhaoCaiCatKfrtStatusBarView.setLayoutParams(params);
        zhaoCaiCatKfrtStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        zhaoCaiCatKfrtStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return zhaoCaiCatKfrtStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static ZhaoCaiCatKfrtStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        ZhaoCaiCatKfrtStatusBarView zhaoCaiCatKfrtStatusBarView = new ZhaoCaiCatKfrtStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        zhaoCaiCatKfrtStatusBarView.setLayoutParams(params);
        zhaoCaiCatKfrtStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        zhaoCaiCatKfrtStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return zhaoCaiCatKfrtStatusBarView;
    }
