...
public class RemindZhaoCaiCatKfrtDialog extends Dialog {
    ...
    public RemindZhaoCaiCatKfrtDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_zhao_cai_mao_dfget_remind);
