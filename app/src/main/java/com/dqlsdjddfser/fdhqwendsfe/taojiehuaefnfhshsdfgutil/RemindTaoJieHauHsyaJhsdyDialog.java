...
public class RemindTaoJieHauHsyaJhsdyDialog extends Dialog {
    ...
    public RemindTaoJieHauHsyaJhsdyDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_tao_jie_hua_djheru_fhentj_remind);
