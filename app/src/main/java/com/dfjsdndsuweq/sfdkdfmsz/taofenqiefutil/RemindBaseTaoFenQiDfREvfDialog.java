...
public class RemindBaseTaoFenQiDfREvfDialog extends Dialog {
    ...
    public RemindBaseTaoFenQiDfREvfDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_tao_fen_qi_rtgr_vbd_remind);
