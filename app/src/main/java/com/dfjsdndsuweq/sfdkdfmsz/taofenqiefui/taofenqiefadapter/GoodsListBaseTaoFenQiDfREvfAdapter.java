...
public class GoodsListBaseTaoFenQiDfREvfAdapter extends BaseQuickAdapter<GoodsBaseTaoFenQiDfREvfModel, BaseViewHolder> {

    private ItemClickListener itemClickListener;

    public GoodsListBaseTaoFenQiDfREvfAdapter(int layoutResId, @Nullable List<GoodsBaseTaoFenQiDfREvfModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, GoodsBaseTaoFenQiDfREvfModel item) {
        ...
        Glide.with(mContext).load(BaseTaoFenQiDfREvfRetrofitManager.API_BASE_URL + item.getProductLogo()).into(goodsPic);
    ...
    public interface ItemClickListener{
        void onItemClicked(GoodsBaseTaoFenQiDfREvfModel item);
    }
}
