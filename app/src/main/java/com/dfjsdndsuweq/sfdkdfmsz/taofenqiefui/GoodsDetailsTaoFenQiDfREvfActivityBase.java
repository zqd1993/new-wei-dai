...
import com.dfjsdndsuweq.sfdkdfmsz.taofenqiefutil.BaseTaoFenQiDfREvfDownloadApkUtil;
...
public class GoodsDetailsTaoFenQiDfREvfActivityBase extends BaseBaseTaoFenQiDfREvfActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_user_ysxy_tao_fen_qi_rtgr_vbd;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(GoodsDetailsTaoFenQiDfREvfActivityBase.this);
        ...
        BaseTaoFenQiDfREvfDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new BaseTaoFenQiDfREvfDownloadApkUtil.OnDownloadListener() {
            @Override
