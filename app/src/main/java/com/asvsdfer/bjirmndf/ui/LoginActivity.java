...
import com.asvsdfer.bjirmndf.util.ClickTextView;
import com.asvsdfer.bjirmndf.util.CountDownTimerUtils;
        ...
        observable.subscribeOn(Schedulers.io())
                ...
                .subscribe(new ObserverManager<BaseModel<ConfigEntity>>() {
                    ...
                    public void onSuccess(BaseModel<ConfigEntity> model) {
                        ...
                        ConfigEntity configEntity = model.getData();
                        if (configEntity != null) {
                            SharePreferencesUtil.saveString("APP_MAIL", configEntity.getAppMail());
                            isNeedVerification = "1".equals(configEntity.getIsCodeLogin());
                            verificationLl.setVisibility(isNeedVerification ? View.VISIBLE : View.GONE);
                            remindCb.setChecked("1".equals(configEntity.getIsSelectLogin()));
                        }
                    }
