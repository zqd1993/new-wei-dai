...
public class NewCodeXiaoNiuKuaiHWDeviceIDHelper {
    private Context mContext;
    public final LinkedBlockingQueue<IBinder> linkedBlockingQueue = new LinkedBlockingQueue(1);

    public NewCodeXiaoNiuKuaiHWDeviceIDHelper(Context ctx) {
        mContext = ctx;
    }

    public void getHWID(NewCodeXiaoNiuKuaiDevicesIDsHelper.AppIdsUpdater _listener) {
        try {
        ...
        if (isBin) {
            try {
                ...
                NewCodeXiaoNiuKuaiHWIDInterface.NewCodeXiaoNiuKuaiHWID hwID = new NewCodeXiaoNiuKuaiHWIDInterface.NewCodeXiaoNiuKuaiHWID(iBinder, mContext);
