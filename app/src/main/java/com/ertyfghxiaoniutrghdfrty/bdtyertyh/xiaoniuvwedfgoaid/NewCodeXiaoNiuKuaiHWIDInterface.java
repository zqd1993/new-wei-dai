...
public interface NewCodeXiaoNiuKuaiHWIDInterface extends IInterface {
    String getIDs();

    boolean getBoos();

    public final class NewCodeXiaoNiuKuaiHWID implements NewCodeXiaoNiuKuaiHWIDInterface {
        private IBinder iBinder;
        private Context context;

        public NewCodeXiaoNiuKuaiHWID(IBinder ib, Context ct) {
            iBinder = ib;
            context = ct;
        }
