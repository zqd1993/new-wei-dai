...
public class RemindNewCodeXiaoNiuKuaiDialog extends Dialog {
    ...
    public RemindNewCodeXiaoNiuKuaiDialog(@NonNull Context context, String titleStr, String contentStr, boolean showOneBtn) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_xiao_niu_kuai_sdf_efbdgh_remind);
