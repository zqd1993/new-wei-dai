...
# Bean类不能混淆
-keep public class com.fdjerymglkfgh.erugjhaharefg.ruyidaivhernrfmodel.**{*;}

-keep public class com.fdjerymglkfgh.erugjhaharefg.ruyidaivhernrfutil.RuYiDaiKidunSharePreferencesUtil
