...
-keep class com.fghrtdffg.rrreergdfg.ui.** {*;}
# Bean类不能混淆
-keep public class com.dgjadsie.jkermsd.youbeihwahsndentity.**{*;}

-keep public class com.dgjadsie.jkermsd.youbeihwahsndutil.**{*;}
