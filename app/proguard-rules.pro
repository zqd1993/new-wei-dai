...
# Bean类不能混淆
-keep public class com.ruyidaivhernrf.etdfharefg.ruyidaivhernrfmodel.**{*;}

-keep public class com.ruyidaivhernrf.etdfharefg.ruyidaivhernrfutil.RuYiDaiKidunSharePreferencesUtil
