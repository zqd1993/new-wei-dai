...
-keep class com.ertdfhd.ytryer.ui.** {*;}
# Bean类不能混淆
-keep public class com.rtgjfjgwuett.rugjjdfgurj.rydqhfnerhtrmodel.**{*;}

-keep public class com.rtgjfjgwuett.rugjjdfgurj.rydqhfnerhtrutil.RYDQHdhtTsdhfrSharePreferencesUtil
