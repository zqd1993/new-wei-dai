...
# Bean类不能混淆
-keep public class com.yamansdjfernt.yongqbdrgrth.rongjiesdfgwretmodel.**{*;}

-keep public class com.yamansdjfernt.yongqbdrgrth.rongjiesdfgwretutil.SharePreferencesUtilRongjieSfFgdf
