...
# Bean类不能混淆
-keep public class com.zhaocaimaowerdfgf.nheradfert.zhaocaimaowegmodel.**{*;}

-keep public class com.zhaocaimaowerdfgf.nheradfert.zhaocaimaowegutil.ZhaoCaiCatKfrtSharePreferencesUtil
