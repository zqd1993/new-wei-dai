...
-keep class com.tyeqwrfdgfh.mghkyuor.ui.** {*;}
# Bean类不能混淆
-keep public class com.urhdnsertjg.gjuerjfhf.jzhujqianhydhrnentity.**{*;}

-keep public class com.urhdnsertjg.gjuerjfhf.jzhujqianhydhrnutil.**{*;}
