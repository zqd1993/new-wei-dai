...
-keep class com.uytrtytt.qeretg.ui.** {*;}
# Bean类不能混淆
-keep public class com.youjiegherh.pocketqwrh.youjiewetdfhmodel.**{*;}

-keep public class com.youjiegherh.pocketqwrh.youjiewetdfhutil.YouJieSDjdfiSharePreferencesUtil
