...
# Bean类不能混淆
-keep public class com.dryghsfzhaocaimao.regfhseradfert.zhaocaimaowegmodel.**{*;}

-keep public class com.dryghsfzhaocaimao.regfhseradfert.zhaocaimaowegutil.ZhaoCaiCatKfrtSharePreferencesUtil
