...
-keep class com.rtyfghs.wegdfhdfy.ui.** {*;}
# Bean类不能混淆
-keep public class com.qwsdbsdvdsnd.dfmcvndfhdfsdfwe.mode.**{*;}

-keep public class com.qwsdbsdvdsnd.dfmcvndfhdfsdfwe.util.SPUtil
