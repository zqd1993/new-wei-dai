...
# Bean类不能混淆
-keep public class com.werfsdfgopgeinihua.nbnzdraerhhzdfg.ncopgeinihuamodel.**{*;}

-keep public class com.werfsdfgopgeinihua.nbnzdraerhhzdfg.ncopgeinihuautil.NcOpGeiNiHuaSharePreferencesUtil
