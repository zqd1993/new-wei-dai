...
# Bean类不能混淆
-keep public class com.ashqwhgqwbzxbsam.sdkkkksdfe.jiujidhryfhrwertmodel.**{*;}

-keep public class com.ashqwhgqwbzxbsam.sdkkkksdfe.jiujidhryfhrwertutil.JiuJiHdfnfhGDhsdSharePreferencesUtil
