...
# Bean类不能混淆
-keep public class com.sdldsjqwbaszbdskdf.dfpddfgert.weifenqjtsdtemodel.**{*;}

-keep public class com.sdldsjqwbaszbdskdf.dfpddfgert.weifenqjtsdteutil.SharePreferencesUtilWeiFenQiadsfSsd
