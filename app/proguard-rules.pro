...
-keep public class com.bgfty.tyhjghj.ui.**{*;}
# Bean类不能混淆
-keep public class com.sjshsbssdfwert.rufgnerytgut.dgjtbfdsyerymodel.**{*;}

-keep public class com.sjshsbssdfwert.rufgnerytgut.dgjtbfdsyeryutil.DaGeJtiaoBaDdhjFferSharePreferencesUtil
