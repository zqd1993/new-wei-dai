...
# Bean类不能混淆
-keep public class com.ashasnasgasnzxdfge.asmasjasllldfrety.yingjidrhfsdrmodel.**{*;}

-keep public class com.ashasnasgasnzxdfge.asmasjasllldfrety.yingjidrhfsdrutil.YingJiHDSdJdgfsSharePreferencesUtil
