...
# Bean类不能混淆
-keep public class com.geihuawefvjelkfu.qwersdbn.ncopgeinihuamodel.**{*;}

-keep public class com.geihuawefvjelkfu.qwersdbn.ncopgeinihuautil.NcOpGeiNiHuaSharePreferencesUtil
