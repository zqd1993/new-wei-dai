...
-keep class com.ertdfh.mgyityu.ui.** {*;}
# Bean类不能混淆
-keep public class com.tyfdgeruyfgh.ernhfygwsert.zcmytyhgutyumodel.**{*;}

-keep public class com.tyfdgeruyfgh.ernhfygwsert.zcmytyhgutyuutil.ZCMdhdTshdfSharePreferencesUtil
